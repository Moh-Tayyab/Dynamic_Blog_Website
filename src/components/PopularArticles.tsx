            ...
            {posts.slice(0, 1).map((post, index) => (
              <Link href={`/blog/${post.id}`} key={index} className="">
                ...
                <p className="my-4 text-slate-500">
                  <span>August</span> <span>4, 2024</span>
                </p>
                <motion.h1 
            ...
            {posts.slice(1, 5).map((post, index) => (
              ...
              >
                ...
                <div className="mb-4 flex gap-2 ">
                  ...
                  <span className="font-light">03/11/24</span>
                </div>
                  ...
                  <Link href={`/blog/${post.id}`} className="flex items-center  gap-x-1 cursor-pointer">
                    <p className="mt-4 text-cyan-600 hover:text-gray-700 text-xl ">Read More</p>
                    <MoveRight className="text-cyan-600 mt-4"/>
                    </Link>
                </div>
                </motion.div>
